...
class User extends Entry implements Authenticatable
{
    ...
    public function changePassword($oldPassword, $newPassword, $replaceNotRemove = false)
    {
        ...
        */
        //// Modificacion de response dentro de la funcion cambio de contraseña
            switch ($code) {
                case '0000052D':
                    return '1';
                ...
                case '00000056':
                    return '2';
                    ////la anterior contraseña no es correcta
                default:
                    return '3'; 
                    /// el error es desconocido por el sistema
            }
        }
        return '0';
    }
