...
@page {
	...
	header { position: fixed; bottom: 955px; left: -50px; right: 0px; height: 50px;}
  </style>
</head>
<body lang=ES-BO>
<header>
<img src="img/cabesera.png" alt="logo" height="100%" >
</header>
<footer>
...
pie de la presente Acta los miembros de la {{ nombre_comite($act->committee_id) }} , {{ company_name($act->company_id) }} y demas instituciones participantes.</p>
<div style="page-breack-after:always;"></div>
