...
<body>
    ...
    <table width="966px" cellpadding="1" cellspacing="0" border="1">
        <tr>
            <td colspan="7" align="center" style=" border-style : solid; border-color: {{$color}}; background: {{$color}}; font-weight:bold; color:#fff; font-size:20px; font-family: Arial, Helvetica, sans-serif;">
                <font style="font-weight:bold; color:#fff; font-size:20px;">
                    PARTICIPANTES
                </font>
            </td>
        ...
        <tbody style="font-weight:light; font-family: Arial, Helvetica, sans-serif;">
            ...
            <tr>
                ...
                <td style="font-size:12px" width="150px">&nbsp;&nbsp;&nbsp;&nbsp; </td>
            </tr>
            @empty
            @endforelse
