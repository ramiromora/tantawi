            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '192.168.2.100')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=ofep,dc=gob,dc=bo'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'Administrator@ofep.gob.bo'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Castlevania1*'),
